...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:osint-catalog', keywords: ['osint tools', 'osint4all', 'osint catalog', 'investigation tools', 'public tools'], label: 'Panel: OSINT Tools', icon: '\u{1F50D}', category: 'panels' },
