...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:osint-catalog', keywords: ['osintdispatch', 'osint dispatch', 'osint tools', 'osint4all', 'osint catalog', 'investigation tools', 'public tools'], label: 'Panel: OSINTDispatch', icon: '\u{1F50D}', category: 'panels' },
  ...
  { id: 'panel:science', keywords: ['science', 'discoveries', 'research', 'space', 'nature'], label: 'Panel: Science Discoveries', icon: '\u{1F52C}', category: 'panels' },
  { id: 'panel:archaeology', keywords: ['archaeology', 'ancient', 'excavation', 'heritage', 'history'], label: 'Panel: Archaeology', icon: '\u{1F3FA}', category: 'panels' },
  { id: 'panel:coverage-compare', keywords: ['coverage compare', 'spin filter', 'talking points', 'nci', 'propaganda', 'bias', 'media comparison'], label: 'Panel: Coverage Compare', icon: '\u{2696}️', category: 'panels' },
