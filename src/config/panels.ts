...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  science: { name: 'Science Discoveries', enabled: true, priority: 1 },
  archaeology: { name: 'Archaeology', enabled: true, priority: 1 },
  'coverage-compare': { name: 'Coverage Compare', enabled: true, priority: 1 },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  topical: {
    ...
    panelKeys: ['energy', 'gov', 'thinktanks', 'science', 'archaeology', 'tech', 'ai', 'layoffs'],
    variants: ['full', 'energy'],
  },
  dataTracking: {
