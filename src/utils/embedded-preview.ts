 ...
 * `https://brians-world-monitor.vercel.app/dashboard?embed=pro-preview` for a visual dashboard
...
export const IS_EMBEDDED_PREVIEW: boolean = (() => {
  ...
  // brians-world-monitor.vercel.app/dashboard?embed=pro-preview (e.g. someone linking with the
