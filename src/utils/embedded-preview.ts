 ...
 * `https://thepublicdispatch.com/dashboard?embed=pro-preview` for a visual dashboard
...
export const IS_EMBEDDED_PREVIEW: boolean = (() => {
  ...
  // thepublicdispatch.com/dashboard?embed=pro-preview (e.g. someone linking with the
