 ...
 * Was fetched from an R2 CDN subdomain this fork doesn't control (silently
 * no-op'd there — see the try/catch below); the same file is already
 * committed at public/data/country-boundary-overrides.geojson, so serve it
 * same-origin instead. */
