...
console.log('  API_BASE_URL=https://api.brians-world-monitor.vercel.app WORLDMONITOR_SEED_REFRESH_KEY=<seed-refresh-key> WORLDMONITOR_API_KEY=<read-key> node scripts/seed-resilience-scores.mjs');
