...
//
// Usage:
//   WORLDMONITOR_API_KEY=wm_xxx API_BASE=https://api.brians-world-monitor.vercel.app \
...
if (!FIXTURE_PATH) {
  if (!API_BASE) {
    console.error('[audit-resilience-cohorts] API_BASE env var required (e.g. https://api.brians-world-monitor.vercel.app), or FIXTURE=path.json for offline mode');
    process.exit(2);
  }
