 ...
 *   (default url: https://brians-world-monitor.vercel.app/dashboard)
 */
...
export function parseArgs(argv) {
  const args = { url: 'https://brians-world-monitor.vercel.app/dashboard', cpu: 4, settle: 15000, json: false };
