...
//
// Usage:
//   API_BASE=https://api.brians-world-monitor.vercel.app node scripts/freeze-resilience-ranking.mjs
//   API_BASE=https://api.brians-world-monitor.vercel.app WORLDMONITOR_API_KEY=... node scripts/freeze-resilience-ranking.mjs
//   API_BASE=https://api.brians-world-monitor.vercel.app WORLDMONITOR_API_KEY=... \
...
async function main() {
  if (!API_BASE) {
    console.error('[freeze-resilience-ranking] API_BASE env var required (e.g. https://api.brians-world-monitor.vercel.app)');
    process.exit(2);
  }
