...
64 enabled channels in the default `full` Telegram channel set provide a raw, low-latency intelligence feed covering conflict zones, OSINT analysis, cyber, and breaking news — sources that are often minutes ahead of traditional wire services during fast-moving events.
...
| `full` | `science` | ScienceDaily; Phys.org; Nature News; Science (AAAS); New Scientist; Live Science; Scientific American; NASA; Space.com; Quanta Magazine; Science Discoveries |
| `full` | `archaeology` | Archaeology Magazine; HeritageDaily; Ancient Origins; Sci.News Archaeology; Smithsonian Archaeology; The Past; Phys.org Archaeology; Archaeology News |
