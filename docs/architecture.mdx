...
description: "Design principles, intelligence tradecraft, and algorithmic decisions behind World Monitor — how the map-first dashboard is engineered and why."
---
...
| **Type-safe data flow**             | Discriminated union markers (`_kind` field), proto-generated typed clients/servers, and exhaustive `switch` matching ensure compile-time safety across 15+ marker types, 35 service domains, and 57 map layers. Adding a new data type produces compiler errors at every unhandled site.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
