---
title: "Map Engine"
description: "How World Monitor renders the 3D globe and flat map — textures, shaders, clustering, camera controls, and mobile touch gesture handling."
---
