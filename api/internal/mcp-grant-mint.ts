 ...
 * `brians-world-monitor.vercel.app/mcp-grant` to the consent flow at
 * `brians-world-monitor.vercel.app/oauth/authorize-pro` (U5).
 *
 * Flow:
 ...
 *
 * The redirect URL host is FIXED to `https://brians-world-monitor.vercel.app` —
...
const AUTHORIZE_PRO_URL = 'https://brians-world-monitor.vercel.app/oauth/authorize-pro';
