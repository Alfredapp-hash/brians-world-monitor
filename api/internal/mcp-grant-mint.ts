 ...
 * `thepublicdispatch.com/mcp-grant` to the consent flow at
 * `thepublicdispatch.com/oauth/authorize-pro` (U5).
 *
 * Flow:
 ...
 *
 * The redirect URL host is FIXED to `https://thepublicdispatch.com` —
...
const AUTHORIZE_PRO_URL = 'https://thepublicdispatch.com/oauth/authorize-pro';
